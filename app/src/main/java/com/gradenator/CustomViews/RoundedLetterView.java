...
public class RoundedLetterView extends View {
    ...
    private static float DEFAULT_TITLE_SIZE = 60f;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        Typeface customFontTypeface = Typeface.createFromAsset(getContext().getAssets(),
                Constant.DEFAULT_FONT);
        mTitleTextPaint.setTypeface(customFontTypeface);
